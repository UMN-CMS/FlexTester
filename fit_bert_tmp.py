...
#        print("self.scan_idx:",  self.scan_idx)
#        print("self.conn:", self.conn)
#        print("scan_mask", scan_mask)
#        print("self.iskip:", self.iskip)
...
#            print("Scan mask is not none. It is", scan_mask)
            self.results = []
...
#        print("In fit_bert_tmp.py: do_fit")
        self.guess = []
...
#        print("In fit_bert_tmp.py: plot scan")
...
#        plt.savefig("elink{}.png".format(self.scan_idx))       
...
#        print("In fit_bert_tmp.py: fit_scan")
        try:
