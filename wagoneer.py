...
class Wagon:
    ...
    def __init__(self):
#        print("Inside of the __init__ method of the Wagon class in wagoneer.py")
...
#        print("self.txmap =", self.txmap)
#        print("Calling the self.config() method in __init__")
        self.config()
#        print("Leaving wagoneer.py and returning to run_bert_tmp.py\n")
...
#        print("Inside of the set_tx_mode method in wagoneer.py")
...
#        print("OUTPUT MODE: ", test)
    ...
    def scan(self, iskip=1):
        scan = []
#        print("Inside of the scan method in wagoneer.py") 
